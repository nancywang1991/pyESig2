...
download_files = [ "a0f66459_vid", "ab2431d9_vid", "d6532718_vid", "d7d5f068_vid", "e5bad52f_vid", "e70923c4_vid", "fcb01f7a_pt1_vid",  "fcb01f7a_pt3_vid", "a0f66459"]
...
for file in download_files:
	if not os.path.exists("/data/%s"%file):
		subprocess.call("azure storage blob download ecog2015 %s /data/%s" % (file, file), shell=True)
        #pdb.set_trace()

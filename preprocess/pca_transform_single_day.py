...
for s, sbj_id in enumerate(sbj_id_all):
    ...
    for day in days:
        ...
        pickle.dump(files_eeg, open("D:\\ecog_processed\\d_reduced_single_day\\index_pca_" + sbj_id + "_" + str(day) + ".p", "wb"))
        ...
        result[:,:] = np.nan
        pca = open("D:\\ecog_processed\\d_reduced\\transformed_pca_model_" + sbj_id + "_" + str(days[0]) + ".p", "rb")
        ...
        pickle.dump(result, open("D:\\ecog_processed\\d_reduced_single_day\\transformed_pca_" + sbj_id + "_" + str(day) + ".p", "wb"))
        pickle.dump(valid_pos, open("D:\\ecog_processed\\d_reduced_single_day\\valid_pos_" + sbj_id + "_" + str(day) + ".p", "wb"))
